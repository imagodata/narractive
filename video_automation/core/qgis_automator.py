...
QGIS Automator
==============
Controls QGIS and any docked plugin panel via PyAutoGUI.
...
class QGISAutomator:
    """
    Automates QGIS interaction via PyAutoGUI.
    ...
    def __init__(self, config: dict) -> None:
        ...
        self.plugin_panel: str = self.qgis_cfg.get("plugin_panel", "")
    ...
    def focus_plugin_panel(self) -> None:
        """Click on the plugin dock panel to ensure it has focus."""
        ...
        if dock:
            ...
            logger.warning("Plugin dock region not calibrated.")
